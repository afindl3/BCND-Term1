...
// 	console.log('Test get height of chain: ' + height);
...
// 	console.log('Test get block 0: ' + block);
// }).catch((err) => { console.log(err) });
...
// 	console.log('Test validity of block 0: ' + valid);
// }).catch((err) => { console.log(err) })
...
//   console.log('Changing block ' + blockAux.height + ' body data...');
//   blockAux.body = "Tampered Block";
// 	myBlockChain._modifyBlock(blockAux.height, blockAux).then((blockModified) => {
// 		if(blockModified){
//      console.log("The Block was modified");
// 			myBlockChain.validateBlock(blockAux.height).then((valid) => {
// 				console.log('Test block ' + blockAux.height + ' is valid: ' + valid);
// 			}).catch((error) => {
// 				console.log(error);
// 			})
// 		} else {
...
//   let blockAux = JSON.parse(block);
//   console.log('Changing block ' + blockAux.height + ' previous block hash...');
